...
const HelplinePage = () => {
  const profiles = [
    ...
    {
      name: 'Dr. Jane Smith',
      researchInterest: 'Cognitive Behavioral Therapy',
      roomId: '201',
      type: 'psychologist'
    },
    {
  ...
  return (
    <div className="helpline-page">
      <header className="header">
        ...
        <div className="header-university-name">University of Rajshahi</div>
      </header>
      <div className="body">
        <div className="profiles-container">
          {profiles.map((profile, index) => (
            <div key={index} className="profile-card">
              <div className="profile-name">Name: {profile.name}</div>
              <div className="profile-detail">
                {profile.type === 'psychiatrist' ? `Degree: ${profile.degree}` : `Research Interest: ${profile.researchInterest}`}
              </div>
              <div className="profile-room-id">Room ID: {profile.roomId}</div>
            </div>
          ))}
        </div>
      </div>
